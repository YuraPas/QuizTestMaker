...
export class QuizEditComponent {
    ...
    constructor(private activatedRoute: ActivatedRoute,
        ...
        this.quiz = <Quiz>{};
        //if there is any paramether passed that means we used a quiz/edit/:id 
        //therefore edit mode is true
        ...
        // if id is not passed that means we navigated throught quiz/create link
        else {
            this.editMode = false;
